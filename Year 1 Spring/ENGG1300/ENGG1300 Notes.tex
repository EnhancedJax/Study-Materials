...
\begin{enumerate}
    \item Find reaction forces by considering equilibrium and moments on one side of any joints
...
\begin{definition}
    ...
    \tcblower
    The \textbf{interia force} acting on an object is the force that arises from the object's acceleration, and is equal to $-ma$.
\end{definition}
...
\begin{knBox}
    ...
    \[F_f=\mu mg\]
    Where $F_f$ is the frictional force, $\mu$ is the coefficient of friction, $m$ is the mass, and $g$ is
\end{knBox}
...
\begin{knBox}
    ...
    \[v=\omega r\]
    Where $r$ is the distance from the IC.
\end{knBox}
...
\begin{theorem}
    ...
    \begin{itemize}
        ...
        \item \textbf{Friction: } $E_{f}=F_f\times d=\mu mgd$
...
\begin{tabular}{|l|l|}
    ...
    Friction                          & $F_f=\mu mg$                                                                            \\
    Motion equations                  & $s=ut+\frac{1}{2}at^2,\ v=u+at,\ v^2=u^2+2as,\ s=\frac{(v+u)t}{2}$                      \\
    ...
    Torque                            & $Fr = Ia_c$                                                                             \\
    Momentum                          & $p=mv, \quad H_O=Iw=mv_i\times r,e=|\frac{v_{2}-v_{1}}{u_{1}-u_{2}}|$                   \\
