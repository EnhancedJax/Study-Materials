...
\begin{theorem}
    ...
    \begin{enumerate}
        ...
        \item Draw the FBD of the solvable joint by \textbf{replacing members with forces}. (By convention, all forces should \emph{point towards} the joint.)
...
\section{Bending internal forces}
