...
\begin{align*}
    ...
    \\
    \int\frac{a'}{b}                                                            & = \int\frac{ab'}{b^2} + \frac{a}{b}                                                                              \\
    \int\frac{\sin{(x^{-\frac{1}{2}})}}{x^2}\:dx                                & = \int\frac{2\cos(x^{-\frac{1}{2}})\frac{1}{2}x^{-\frac{1}{2}}}{x}\:dx + \frac{2\cos(x^{-\frac{1}{2}})}{x^{1/2}} \\
    ...
    \therefore                                                                  & = -2\sin(x^{-\frac{1}{2}}) + 2\frac{\cos(x^{-1/2})}{x^{1/2}} + c                                                 \\
\end{align*}
Verification:
\begin{align*}
