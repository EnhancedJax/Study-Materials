...
\begin{align*}
    ...
    s\to 0:\quad 0                      & = Ab^2+Bab-Ca                                                                    \\
                                        & = \frac{a^2b^2}{(a-b)^2}+Bab-\frac{ab^2}{a-b}                                    \\
    Bab                                 & = \frac{b^2a}{b-a}-\frac{a^2b^2}{(a-b)^2}                                        \\
    B                                   & = \frac{b(b-a)-ab}{(b-a)^2}                                                      \\
                                        & = \frac{b^2-2ab}{(b-a)^2}                                                        \\
    \therefore \frac{s^2}{(s-a)(s-b)^2} & = \frac{a^2}{(a-b)^2(s-a)}+\frac{b^2-2ab}{(b-a)^2(s-b)}+\frac{b^2}{(b-a)(s-b)^2}
\end{align*}
\section*{Question 5}
