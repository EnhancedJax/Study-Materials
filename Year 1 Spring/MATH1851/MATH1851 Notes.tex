...
\begin{knBox}
    {Partial fractions}
    A fraction can be decomposed into partial fractions if the degree of the numerator is \textbf{less than the degree of the denominator}. The following are the types of partial fractions:
    \begin{enumerate}
...
\begin{tabular}{|l|l|}
    ...
    Is differentiable                   & $\lim_{x\to a^-}f' = \lim_{x\to a^+}f'$ (for cased, use first principle)                                                                                                                                                                                                                             \\
    IVT                                 & If $f$ continuous in $[a,b]$, then $\exists\ c\in[a,b]:f(c)\in[f(a),f(b)]$                                                                                                                                                                                                                           \\
    ...
    Logarithmic differentiation         & Take nautral log of both sides                                                                                                                                                                                                                                                                       \\
    ...
    Partial fractions                   & $\frac{k}{f(x)g(x)}=\frac{A}{f(x)}+\frac{B}{g(x)}$                                                                                                                                                                                                                                                   \\
    Trigo substitution                  & $\begin{cases}a^2-f(x)^2 & \to f(x)=a\sin\theta\\a^2+f(x)^2 & \to f(x)=a\tan\theta \\f(x)^2-a^2 & \to f(x)=a\sec\theta \\\end{cases}$                                                                                                                                                                \\
    Volume by Washers (Disk)            & $\{f(x)\to\ \circlearrowright x\}:\quad V=\pi\int_{a}^{b}R^2(x)-r^2(x)dx$                                                                                                                                                                                                                            \\
    Volume by Cylindrical shells        & $\{f(x)\to\ \circlearrowright y\}:\quad V=2\pi\int_{a}^{b}[x][R(x)-r(x)]dx$                                                                                                                                                                                                                          \\
    ...
    Parametized equations (above 2)     & $\sqrt{f'^2(t)+g'^2(t)}dt$                                                                                                                                                                                                                                                                           \\\hline
\end{tabular}
\newpage
\begin{tabular}{|l|l|}
    \hline
    ...
    Solve by Laplace          & $y(t)\to Y(s)\to$ change subject $Y(s)\to y(t)$                                                                                           \\\hline
\end{tabular}
