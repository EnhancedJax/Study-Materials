...
\subsubsection{Stockholder's Equity Items}
...
\begin{knBox}
    ...
    The amount of money that shareholders have contributed to the company less the stock issurance.
    \begin{center}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.1\textwidth}|p{0.35\textwidth}|p{0.35\textwidth}|}
        ...
        \textbf{NC} & Long-Term Investments  & Bonds Payable (long-term)           \\
                    ...
                    & Intangibles            &                                     \\
        \hline
        Keywords    &                        & payable, unearned, accrued expenses \\
        \hline
    \end{tabular}
...
% \begin{theorem}
%     {Respecting the Accural Method \& Unearned Revenue \& Accounts Receivable}
%     If cash is received \textit{before} the service is provided, it is recorded as \textbf{Unearned Revenue}.

%     If the service is provided \textit{before} cash is received, it is recorded as \textbf{Accounts Receivable}.

%     \tcblower
%     Consider the example of a food delivery service:
%     \begin{itemize}
%         \item You're a customer.
%         \item You deposit \$100 to the ordering service: Cash +100, \textbf{Unearned Revenue} +100
%         \item You receive the order: \textbf{Unearned Revenue} -100, \textbf{Accounts Receivable} +100
%     \end{itemize}
%     \begin{itemize}
%         \item You're a delivery driver.
%         \item You deliver the order: \textbf{Accounts Receivable} +100, \textbf{Revenue} +100
%         \item You receive the payment: \textbf{Accounts Receivable} -100, \textbf{Cash} +100
%     \end{itemize}
% \end{theorem}
% \label{def:arp}
